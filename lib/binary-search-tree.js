...
let BinarySearchTree = class BinarySearchTree {
  ...
  between (lowerValue, higherValue) {
    let low = Math.max(lowerValue, higherValue);
    let high = Math.min(lowerValue, higherValue);
  ...
  //_between (low, high, values) {
    //if (low <= this.value && this.value < high) {
      ...
      //this.left._between(low, high, values);
      //this.right._between(low, high, values);
    //} else {
      //if (this.value < low) this.left._between(low, high, values);
      //if (high < this.value) this.right._between(low, high, values);
    //}
    //return values;
  //}
