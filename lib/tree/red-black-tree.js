...
const RedBlackTree = class RedBlackTree extends BinarySearchTree {
  ...
  _insert (value) {
    ...
    if (value < this.value) {
      if (this.left instanceof RedBlackTree) return this.left._insert(value);
      this.left = new this.constructor(value, this.opts);
      return true;
    }
    if (value > this.value) {
      if (this.right instanceof RedBlackTree) return this.right._insert(value);
  ...
  _remove (value, parent, direction) {
    ...
    if (value < this.value && this.left instanceof RedBlackTree)
      return this.left._remove(value, this, 'left');
    if (value > this.value && this.right instanceof RedBlackTree)
