...
class RedBlackTreeNode {
  ...
  remove (value) {
    ...
    if (this.left.value === null && this.right.value === null) {
      if (this === this.parent.left) {
        this.parent.left = new RedBlackTreeNode(null, 'black', this);
        return;
      }
      this.parent.right = new RedBlackTreeNode(null, 'black', this);
      return;
    }
  ...
  swapWith(node) {
    ...
    node.value = temp;
    // NOTE: Should it also switch parent, child references?
    return;
  }
