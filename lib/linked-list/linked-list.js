...
const LinkedList = class LinkedList {
   ...
   *
   * @param {String|Number|Array|Object|Boolean|Function|Null}
   ...
   *
   * @param {Number}
   * @returns {String|Number|Array|Object|Boolean|Function|Null}
   */
  get (index) {
    assertNumber(index);
  ...
  *entries(){
   ...
   *
   * @yield {String|Number|Array|Object|Boolean|Function|Null}
   */
  *values(){
